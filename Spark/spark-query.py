...
input_path = 's3://airline-delay-bucket/Input/DelayedFlights-updated.csv'
...
# Define the output path on aws S3
output_base_path = 's3://airline-delay-bucket/SparkSession/outputFolder/'
...
output_file_path = 's3://airline-delay-bucket/SparkSession/outputFolder/spark_iteration_results.txt'  
...
csv_output_path = "s3://airline-delay-bucket/SparkSession/outputFolder/result.csv"
